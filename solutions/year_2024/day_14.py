...
def move_guard(guard: tuple[complex, complex], t: int, bounds: tuple[int, int]) -> tuple[int, int]:
    pos, vel = guard
    pos = pos + vel * t
...
def part1(input_data: list[str] | None, bounds: tuple[int, int] = (101, 103)) -> str | int:
    """
